...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, e as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, f as RequestStatusResponseStatus, U as UnknownError, g as RequestStatusDoneNoReplyErrorCode, h as RejectError, i as CertifiedRejectErrorCode, k as UNREACHABLE_ERROR, I as InputError, m as InvalidReadStateRequestErrorCode, n as ReadRequestType, o as Principal, p as IDL, q as MissingCanisterIdErrorCode, H as HttpAgent, s as encode, Q as QueryResponseStatus, t as UncertifiedRejectErrorCode, v as isV3ResponseBody, w as isV2ResponseBody, x as UncertifiedRejectUpdateErrorCode, y as UnexpectedErrorCode, z as decode, S as Subscribable, A as pendingThenable, B as resolveEnabled, D as shallowEqualObjects, F as resolveStaleTime, G as noop$1, J as environmentManager, K as isValidTimeout, N as timeUntilStale, O as timeoutManager, V as focusManager, W as fetchState, X as replaceData, Y as notifyManager, Z as hashKey, _ as getDefaultState, r as reactExports, $ as shouldThrowError, a0 as useQueryClient, a1 as useInternetIdentity, a2 as createActorWithConfig, j as jsxRuntimeExports, L as Link, a3 as Variant, a4 as Record, a5 as Vec, a6 as Opt, a7 as Service, a8 as Func, a9 as Nat, aa as Null, ab as Text, ac as Bool, ad as Int, ae as Principal$1, c as React, af as useNavigate } from "./index-DnsDxaON.js";
...
function JobBadge({ type, className = "" }) {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-display font-bold text-foreground tracking-tight", children: "JobsDaily" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Your daily destination for Government, Private, and Corporate job opportunities across India." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-wide", children: "Categories" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: "hover:text-foreground transition-colors duration-200",
                  children: "Corporate Jobs"
                }
              ) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-wide", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-wide", children: "Company" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
...
const JobsPage = Record({
  "total": Nat,
  "jobs": Vec(Job),
  "page": Nat,
  "pageSize": Nat
});
const UpdateJobArgs = Record({
  "id": JobId,
  "title": Text,
  "responsibilities": Vec(Text),
  "jobType": JobType$1,
...
Service({
  "createJob": Func([CreateJobArgs], [Job], []),
  "deleteJob": Func([JobId], [Bool], []),
  "getAdminPrincipal": Func([], [Opt(Principal$1)], ["query"]),
  "getJobById": Func([JobId], [Opt(Job)], ["query"]),
  "getJobs": Func([JobFilters], [JobsPage], ["query"]),
  "isAdmin": Func([], [Bool], ["query"]),
  "setAdmin": Func([Principal$1], [], []),
  "updateJob": Func([UpdateJobArgs], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const JobType2 = IDL2.Variant({
    "Private": IDL2.Null,
    "Corporate": IDL2.Null,
    "Government": IDL2.Null
  });
  const CreateJobArgs2 = IDL2.Record({
    "title": IDL2.Text,
    "responsibilities": IDL2.Vec(IDL2.Text),
    "jobType": JobType2,
    "description": IDL2.Text,
    "company": IDL2.Text,
    "salaryRange": IDL2.Text,
    "requirements": IDL2.Vec(IDL2.Text),
    "location": IDL2.Text
  });
  ...
  const JobsPage2 = IDL2.Record({
    "total": IDL2.Nat,
    "jobs": IDL2.Vec(Job2),
    "page": IDL2.Nat,
    "pageSize": IDL2.Nat
  });
  const UpdateJobArgs2 = IDL2.Record({
    "id": JobId2,
    "title": IDL2.Text,
    "responsibilities": IDL2.Vec(IDL2.Text),
    "jobType": JobType2,
  ...
  return IDL2.Service({
    "createJob": IDL2.Func([CreateJobArgs2], [Job2], []),
    "deleteJob": IDL2.Func([JobId2], [IDL2.Bool], []),
    "getAdminPrincipal": IDL2.Func([], [IDL2.Opt(IDL2.Principal)], ["query"]),
    "getJobById": IDL2.Func([JobId2], [IDL2.Opt(Job2)], ["query"]),
    "getJobs": IDL2.Func([JobFilters2], [JobsPage2], ["query"]),
    "isAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "setAdmin": IDL2.Func([IDL2.Principal], [], []),
    "updateJob": IDL2.Func([UpdateJobArgs2], [IDL2.Bool], [])
  });
};
...
var JobType = /* @__PURE__ */ ((JobType2) => {
  JobType2["Private"] = "Private";
  JobType2["Corporate"] = "Corporate";
  JobType2["Government"] = "Government";
  return JobType2;
})(JobType || {});
class Backend {
...
function from_candid_JobsPage_n13(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "Private" in value ? "Private" : "Corporate" in value ? "Corporate" : "Government" in value ? "Government" : value;
}
...
function to_candid_JobFilters_n11(_uploadFile, _downloadFile, value) {
...
function to_candid_UpdateJobArgs_n16(_uploadFile, _downloadFile, value) {
...
const NAV_LINK_CLASS = "text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-200";
const NAV_LINK_ACTIVE_CLASS = "text-sm font-medium text-foreground";
const MOBILE_NAV_CLASS = "block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition-colors";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              "data-ocid": "logo",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-md bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-4 w-4 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-display font-bold text-foreground tracking-tight", children: "JobsDaily" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-3", children: isLoggedIn && isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "default",
            ...
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { className: "h-4 w-4 mr-1.5" }),
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pt-2", children: isLoggedIn && isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    variant: "default",
...
function toBackendJobType(t) {
  if (t === "Private") return JobType.Private;
  if (t === "Corporate") return JobType.Corporate;
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.getJobs({
        jobType: filters.jobType ? toBackendJobType(filters.jobType) : void 0,
...
function useJob(id2) {
  const { actor, isFetching: actorFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["job", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === null) return null;
      return actor.getJobById(id2);
    },
    enabled: id2 !== null && !!actor && !actorFetching
  });
}
