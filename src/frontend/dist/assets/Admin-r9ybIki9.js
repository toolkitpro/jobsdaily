import { r as reactExports, j as jsxRuntimeExports, R as React2, b as reactDomExports, c as React, d as ReactDOM } from "./index-DnsDxaON.js";
import { u as ue } from "./index-Td0nFu7q.js";
import { c as createLucideIcon, d as createSlot$1, e as cn, f as composeRefs, g as useComposedRefs, h as useAdmin, u as useJobs, i as useCreateJob, j as useUpdateJob, k as useDeleteJob, L as Layout, B as Button, a as Briefcase, S as Skeleton, J as JobBadge, m as motion } from "./useJobs-CrnWt-AV.js";
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-b border-border flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-display font-bold text-foreground", children: mode === "create" ? "Post New Job" : "Edit Job" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              "form",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "salaryRange", children: "Salary Range *" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          id: "salaryRange",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "jobType", children: "Job Type *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        value: form.jobType,
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "jobType", "data-ocid": "form-jobtype", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select type" }) }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "requirements", children: "Requirements (one per line)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Textarea,
                      {
                        id: "requirements",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "responsibilities", children: "Responsibilities (one per line)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Textarea,
                      {
                        id: "responsibilities",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-end pt-2 border-t border-border", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: isLoading ? "Saving…" : mode === "create" ? "Post Job" : "Save Changes"
                      }
                    )
                  ] })
                ]
...
function AdminPage() {
  const { isAdmin, isLoggedIn, login, isLoggingIn, isInitializing } = useAdmin();
  const [showForm, setShowForm] = reactExports.useState(false);
  const [editJob, setEditJob] = reactExports.useState(null);
  ...
  if (isInitializing) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-full border-2 border-primary border-t-transparent animate-spin" }) }) });
  }
  if (!isLoggedIn || !isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "h-7 w-7 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-display font-bold text-foreground", children: "Admin Access Required" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Log in with Internet Identity to access the admin panel and manage job postings." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
  ...
  const handleCreate = (form) => {
    ...
    createJob.mutate(args, {
      ...
      onError: () => ue.error("Failed to post job. Please try again.")
    });
  };
  const handleUpdate = (form) => {
    ...
    updateJob.mutate(
      ...
      },
      {
        ...
        onError: () => ue.error("Failed to update job. Please try again.")
      }
    );
  };
  const handleDelete = (id) => {
    deleteJob.mutate(id, {
      onSuccess: () => {
        ue.success("Job deleted.");
        setDeleteConfirm(null);
      },
      onError: () => ue.error("Failed to delete job.")
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage daily job postings" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8", children: ["All", "Government", "Private", "Corporate"].map(
        (type) => {
          const count2 = type === "All" ? (data == null ? void 0 : data.jobs.length) ?? 0 : (data == null ? void 0 : data.jobs.filter((j) => j.jobType === type).length) ?? 0;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1 uppercase tracking-wide", children: type }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground", children: isFetching ? "—" : count2 })
              ]
            },
            type
          );
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-border flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "All Job Postings" })
            ] }),
            isFetching ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 space-y-3", children: Array.from({ length: 4 }, (_, i) => `skel-${i}`).map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-md" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-border", children: [
              data == null ? void 0 : data.jobs.map((job) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: job.title }),
              ...
              (!data || data.jobs.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "px-6 py-12 text-center text-muted-foreground text-sm",
                  "data-ocid": "admin-empty-state",
                  children: 'No jobs posted yet. Click "Post New Job" to get started.'
                }
              )
            ] })
          ]
    ...
    editJob && /* @__PURE__ */ jsxRuntimeExports.jsx(
      JobFormModal,
      {
        mode: "edit",
        initial: {
    ...
    deleteConfirm !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border shadow-xl p-6 max-w-sm w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-display font-bold text-foreground mb-2", children: "Delete Job Posting?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: "This action cannot be undone. The job will be permanently removed." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-end", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setDeleteConfirm(null), children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "destructive",
